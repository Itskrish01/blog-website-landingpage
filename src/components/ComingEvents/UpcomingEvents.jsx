          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mb-10">
            <div className="border-[1px] p-4 sm:p-6 group transition-all border-white hover:border-myblack duration-300 cursor-pointer rounded">
              <div className="overflow-hidden rounded">
                <img
                  src="https://uploads-ssl.webflow.com/6440a62ad0addedfa9c2db95/6440dc31a34d271802c79546_Blog%207-p-800.jpg"
                  alt="image"
            ...
            <div className="border-[1px] p-4 sm:p-6 group transition-all border-white hover:border-myblack duration-300 cursor-pointer rounded">
              <div className="overflow-hidden rounded">
                <img
                  src="https://uploads-ssl.webflow.com/6440a62ad0addedfa9c2db95/6440ddd0f3e5b6099b9bf07a_Blog%2014-p-800.jpg"
                  alt="image"
                  className="rounded group-hover:scale-105 transition-all duration-200"
                />
              </div>
            ...
            <div className="cabin-font sm:hidden block w-full ">
